...
CustomKeywords.'lib.Actions.click'(findTestObject('Object Repository/NewOpportunity/SaveButton'))

CustomKeywords.'pages.NewOpportunityPageUtils.checkValidationsInNewOpportunityModal'()
